...
void mainMenu(), story(), optionsMenu(), difficulty(), help(), easy1(), medium1(), hard1(), loadLocation(), LoadFile(), resetConfirm(), gameOver(), LoadFight(), gameWin(), dumbResponses();
...
case 'E':
  cout<<"ummm... just close the tab... or hit stop...\n";
  mainMenu();
  break;
